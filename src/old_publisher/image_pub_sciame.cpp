...
std_msgs::String msg;
 string ss,ss1,ss2,ss3,ss4,ss5,ss6;
   ...
   ss1 = boost::str(boost::format("%f,%f,%f,%f,") %avRobList.robList[0].id %avRobList.robList[0].coord.x %avRobList.robList[0].coord.y %avRobList.robList[0].lost);
   ss2 = boost::str(boost::format("%f,%f,%f,%f,") %avRobList.robList[1].id %avRobList.robList[1].coord.x %avRobList.robList[1].coord.y %avRobList.robList[1].lost);
   ss3 = boost::str(boost::format("%f,%f,%f,%f,") %avRobList.robList[2].id %avRobList.robList[2].coord.x %avRobList.robList[2].coord.y %avRobList.robList[2].lost);
   ss4 = boost::str(boost::format("%f,%f,%f,%f,") %avRobList.robList[3].id %avRobList.robList[3].coord.x %avRobList.robList[3].coord.y %avRobList.robList[3].lost);
   ss5 = boost::str(boost::format("%f,%f,%f,%f,") %avRobList.robList[4].id %avRobList.robList[4].coord.x %avRobList.robList[4].coord.y %avRobList.robList[4].lost);
   ss6 = boost::str(boost::format("%f,%f,%f,%f")  %avRobList.robList[5].id %avRobList.robList[5].coord.x %avRobList.robList[5].coord.y %avRobList.robList[5].lost);
...
void roblistCallback(const std_msgs::String::ConstPtr& msg){
  ...
  avRobList.robList[0].id=atoi(fields[0].c_str());  avRobList.robList[0].coord.x=atof(fields[1].c_str());  avRobList.robList[0].coord.y=atof(fields[2].c_str());  avRobList.robList[0].lost=atoi(fields[3].c_str());
  avRobList.robList[1].id=atoi(fields[4].c_str());  avRobList.robList[1].coord.x=atof(fields[5].c_str());  avRobList.robList[1].coord.y=atof(fields[6].c_str());  avRobList.robList[1].lost=atoi(fields[7].c_str());
  avRobList.robList[2].id=atoi(fields[8].c_str());  avRobList.robList[2].coord.x=atof(fields[9].c_str());  avRobList.robList[2].coord.y=atof(fields[10].c_str()); avRobList.robList[2].lost=atoi(fields[11].c_str());
  avRobList.robList[3].id=atoi(fields[12].c_str()); avRobList.robList[3].coord.x=atof(fields[13].c_str()); avRobList.robList[3].coord.y=atof(fields[14].c_str()); avRobList.robList[3].lost=atoi(fields[15].c_str());
  avRobList.robList[4].id=atoi(fields[16].c_str()); avRobList.robList[4].coord.x=atof(fields[17].c_str()); avRobList.robList[4].coord.y=atof(fields[18].c_str()); avRobList.robList[4].lost=atoi(fields[19].c_str());
  avRobList.robList[5].id=atoi(fields[20].c_str()); avRobList.robList[5].coord.x=atof(fields[21].c_str()); avRobList.robList[5].coord.y=atof(fields[22].c_str()); avRobList.robList[5].lost=atoi(fields[23].c_str());
...
int checkDistMarker(float a, float b) {
   ...
   //per immagine HSV
    CvScalar lowRed = cvScalar(0,23, 73);
    CvScalar highRed = cvScalar(22, 256, 256);

   CvScalar lowGreen = cvScalar(56, 214, 59);
   CvScalar highGreen = cvScalar(180, 256,256);
    //****************************************  
...
int main(int argc, char **argv) {
    ...
    ros::init(argc, argv, "webcam_pub_sciame");
...
//// %EndTag(SUBSCRIBER)%
    ...
    pub_f = it_f.advertise("camera_sciame/imageRobots", 1);
...
// %EndTag(SUBSCRIBER)%
    ...
    while (1) {
        ...
        //         /*publishing of green channel threshold*/
        //       cv::Mat image2(imgThreshGreen);
        //                 
        //       // out_msg.header   = cv_ptr->header; // Same timestamp and tf frame as input image
        //        out_msg.encoding = sensor_msgs::image_encodings::MONO8; // Or whatever
        //        out_msg.image    = image2; // Your cv::Mat
        //                
        //  pub_g.publish(out_msg.toImageMsg());
        // ros::spin();
